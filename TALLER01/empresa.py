...
while True:
    ...
    if opc ==1:
        ...
        if opc2 == '1':
            os.system("cls")
            notas = OpcSistema("0928068998","Central de riesgo","95","Angie Carrasco","Personal natural","Cnt","0928068998001")
        ...
        if opc4 == '1':
            os.system("cls")
            notas2= OpcSistema("0928068998","Angie Carrasco","96","Floritza","Administradora","Cnt","0928068998001")
